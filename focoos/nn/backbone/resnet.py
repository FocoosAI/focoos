...
from focoos.nn.layers.conv import CNNBlockBase, Conv2d
...
class ResNet(Backbone):
    ...
    def __init__(
        ...
        stages = make_resnet_stages(depth, norm=norm, dilation=dilation)
    ...
    def make_stage(block_class, num_blocks, *, in_channels, out_channels, **kwargs):
        ...
        ::
            stage = ResNet.make_stage(
                BottleneckBlock, 3, in_channels=16, out_channels=64, bottleneck_channels=16, num_groups=1, stride_per_block=[2, 1, 1], dilations_per_block=[1, 1, 2]
            )
...
def make_resnet_stages(depth, block_class=None, dilation=(1, 1, 1, 1), **kwargs):
    ...
    for n, s, d, i, o in zip(num_blocks_per_stage, strides, dilation, in_channels, out_channels):
        if depth >= 50:
            kwargs["bottleneck_channels"] = o // 4
            kwargs["dilation"] = d
