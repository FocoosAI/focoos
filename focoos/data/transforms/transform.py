...
class ColorAugSSDTransform(Transform):
    ...
    def convert(self, img, alpha: float = 1, beta: float = 0):
    ...
    def __repr__(self):
        return f"ColorAugSSDTransform(img_format={self.img_format}, brightness_delta={self.brightness_delta}, contrast_low={self.contrast_low}, contrast_high={self.contrast_high}, saturation_low={self.saturation_low}, saturation_high={self.saturation_high}, hue_delta={self.hue_delta})"
