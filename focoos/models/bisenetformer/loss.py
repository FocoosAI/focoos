...
class SetCriterion(nn.Module):
    ...
    def loss_labels(self, outputs, targets: list[BisenetFormerTargets], indices, num_masks, log=False):
    ...
    def loss_masks(self, outputs, targets: list[BisenetFormerTargets], indices, num_masks):
    ...
    def forward(self, outputs, targets: list[BisenetFormerTargets]):
...
class MaskHungarianMatcher(nn.Module):
    ...
    @torch.no_grad()
    def memory_efficient_forward(self, outputs, targets: list[BisenetFormerTargets]):
